...
Original file is located at
    https://colab.research.google.com/drive/1yjxj_UMHB0pIW7Uok0PJHXByMzbQIeHJ
"""
...
nii_path = '/content/drive/My Drive/dataset/data/nii/'
save_path = '/content/drive/My Drive/dataset//data/h5/'
TEST_PERCENTAGE = 0.2
VAL_PERCENTAGE = 0.16
